...
> = {
  primary:
    "hover:!bg-white/20 focus-visible:ring-white/70 focus-visible:ring-offset-bg-primary",
  fertile:
    "hover:!bg-fertile/10 focus-visible:ring-fertile/40 focus-visible:ring-offset-base-light",
  error:
    "hover:!bg-white/20 focus-visible:ring-white/70 focus-visible:ring-offset-bg-error",
};
